...
<header class="w3-display-container  w3-content" style="max-width:1700px;"> 
  ...
  <div class="w3-display-middle " style="width:30%">
    ...
    <div  class="w3-container w3-red w3-card-4 w3-padding-16 " style="min-width:300px" >
      <h3><center>We just need your email...</center></h3>
      <form action="forgot" method="POST">
       ...
       <p>
     <center>
          <button class="w3-button w3-dark-grey w3-border" name="forgot_btn">Send Email</button>
        </center>
        </p>
        </form>
